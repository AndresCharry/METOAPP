...
def datos():
    ...
    lista = []
    diccionario = {}
    df = pd.read_csv('/home/andres/Documentos/programacion/trabajo de grado/web/ProjectWeb/Variables/baseDeDatos/Variables_csv/marcadores_xy.csv',)
    marcadores = df.to_dict('list')
    df = pd.read_csv('/home/andres/Documentos/programacion/trabajo de grado/web/ProjectWeb/Coordenadas/baseDeDatos/coordenadas_csv/coordenasReferencia.csv', header=0)
